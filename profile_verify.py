from buisness_logic.cards.drift_mining_card import DriftMiningOneStoneCard
...
class DeterministicPlayer(BasePlayerService):
    ...
    def get_player_choice_location_to_build_twin(self, tile_type, turn_descriptor):
        ...
        return ResultLookup(True, TileTwinPlacementLookup(12, TileDirectionEnum.down))
