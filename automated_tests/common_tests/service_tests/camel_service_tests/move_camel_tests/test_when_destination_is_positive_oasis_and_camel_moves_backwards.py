...
from common.services.camel_service import CamelColourEnum, OasisTypeEnum, CamelService, CamelPositions, CamelStack
...
class test_when_destination_is_positive_oasis(Given_A_CamelService):
    def because(self) -> None:
        ...
        camel_positions: CamelPositions = CamelPositions({
            ...
            6: CamelStack([CamelColourEnum.yellow, CamelColourEnum.blue, CamelColourEnum.white])
        })
