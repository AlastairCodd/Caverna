...
from common.services.camel_service import CamelColourEnum, OasisTypeEnum, CamelPositions, CamelStack


class test_when_destination_is_negative_oasis(Given_A_CamelService):
