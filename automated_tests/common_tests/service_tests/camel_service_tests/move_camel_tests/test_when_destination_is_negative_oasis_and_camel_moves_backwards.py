...
from common.services.camel_service import CamelColourEnum, OasisTypeEnum, CamelService, CamelStack, CamelPositions
...
class test_when_destination_is_negative_oasis_and_camel_moves_backwards(Given_A_CamelService):
    def because(self) -> None:
        ...
        camel_positions: CamelPositions = CamelPositions({
            ...
            5: CamelStack([CamelColourEnum.white]),
            6: CamelStack([CamelColourEnum.yellow, CamelColourEnum.blue, CamelColourEnum.green]),
        })
