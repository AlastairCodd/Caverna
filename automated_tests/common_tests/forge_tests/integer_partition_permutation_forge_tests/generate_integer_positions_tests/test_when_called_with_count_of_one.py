...
class Test_When_called_with_count_of_one(Given_A_IntegerPartitionPermutationForge):
    def because(self) -> None:
        self._result: List[List[int]] = list(self.SUT.generate_integer_positions(1, 4))
        
    def test_then_result_should_be_expected(self) -> None:
        self.assertListEqual([[0],[1],[2],[3],[4]], self._result)
