...
class test_when_veg_is_planted(Given_An_AllowFarmingEffect):
    def because(self) -> None:
        ...
        self._result: ResultLookup[bool] = self.SUT.plant_resource(self._player, ResourceTypeEnum.veg)
    ...
    def test_then_sut_planted_type_should_be_expected(self) -> None:
        self.assertEqual(self.SUT.planted_resource_type, ResourceTypeEnum.veg)

    def test_then_sut_planted_amount_should_be_expected(self) -> None:
        self.assertEqual(self.SUT.planted_resource_amount, 2)
