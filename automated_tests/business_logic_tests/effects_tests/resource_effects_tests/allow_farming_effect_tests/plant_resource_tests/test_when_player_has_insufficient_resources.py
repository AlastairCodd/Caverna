...
class test_when_player_has_insufficient_resources(Given_An_AllowFarmingEffect):
    ...
    def test_then_sut_planted_type_should_be_expected(self) -> None:
        self.assertEqual(self.SUT.planted_resource_type, None)

    def test_then_sut_planted_amount_should_be_expected(self) -> None:
        self.assertEqual(self.SUT.planted_resource_amount, 0)
