...
class test_when_is_not_first_expedition(Given_An_ExpeditionRewardActionChoiceProcessorService):
    def because(self) -> None:
        ...
        self._expected_indexes: List[int] = [6 + number_of_possible_rewards, 15 + number_of_possible_rewards, 21 + number_of_possible_rewards]
        ...
        for index, reward in zip(self._expected_indexes, self._expected_rewards):
            ...
            possible_actions[index - number_of_possible_rewards] = reward

        action_choice[2] = out_of_range_action_weighting
        action_choice[16] = out_of_range_action_weighting
        action_choice[17] = out_of_range_action_weighting
