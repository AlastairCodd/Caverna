...
from core.services.base_player_service import BasePlayerRepository
...
class Test_When_There_Are_Multiple_Greatest_Resource_Permutations(Given_A_MostResourcesPermutationOrderingService):
    def because(self) -> None:
        ...
        permutation2: Tuple[List[BaseAction], int, BasePlayerRepository] = ([MockAction()], 3, player2)
        permutation3: Tuple[List[BaseAction], int, BasePlayerRepository] = ([MockAction()], 3, player3)
        ...
        self._greatest_resource_permutations: List[Tuple[List[BaseAction], int, BasePlayerRepository]] = [permutation1, permutation2]

        self._result: ResultLookup[List[Tuple[List[BaseAction], int, BasePlayerRepository]]] = self.SUT.find_best_permutation(successful_permutations)
