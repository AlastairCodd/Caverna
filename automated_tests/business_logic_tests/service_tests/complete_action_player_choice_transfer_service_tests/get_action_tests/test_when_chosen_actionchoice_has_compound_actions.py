...
from automated_tests.business_logic_tests.service_tests.complete_action_player_choice_transfer_service_tests.given_a_complete_action_player_choice_transfer_service import \
    Given_A_CompleteActionPlayerChoiceTransferService, FakeCompoundAction
...
class test_when_chosen_actionchoice_has_compound_actions(Given_A_CompleteActionPlayerChoiceTransferService):
    def because(self) -> None:
        ...
        base_action_1: FakeCompoundAction = FakeCompoundAction()

        additional_action_1: BaseAction = NullAction()
        additional_action_2: BaseAction = NullAction()
        additional_constraint_1: BaseConstraint = PrecedesConstraint(
            additional_action_1,
            additional_action_2)

        self._additional_action_choice_lookup: ActionChoiceLookup = ActionChoiceLookup(
            [additional_action_1, additional_action_2],
        ...
        self._expected_constraints: List[BaseConstraint] = [
            ...
            additional_constraint_1,
            PrecedesConstraint(base_action_1, additional_action_1),
            PrecedesConstraint(base_action_1, additional_action_2),
        ]
