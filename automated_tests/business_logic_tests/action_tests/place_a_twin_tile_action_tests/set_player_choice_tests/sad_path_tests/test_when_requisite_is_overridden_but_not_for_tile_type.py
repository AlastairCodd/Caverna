...
class test_when_requisite_is_overridden_by_tile_effect_and_direction_is_invalid(Given_A_PlaceATwinTileAction):
    def because(self) -> None:
        self.initialise_sut_with_twin_tile(
            tile_type=TileTypeEnum.oreMineDeepTunnelTwin
        )
