...
from buisness_logic.tiles.outdoor_tiles import MeadowTile, PastureTwinTile
...
class test_when_tile_cost_is_default(Given_A_PlaceATwinTileAction):
    def because(self) -> None:
        self.initialise_sut_with_twin_tile(TileTypeEnum.pastureTwin)
    ...
    def initialise_player(self) -> BasePlayerService:
        ...
        # _ x x F | D x x _
        # _ _ _ _ | _ _ _ _
        location_to_place_primary_tile: int = 27
        location_to_place_secondary_tile: int = location_to_place_primary_tile + 8
        player.tiles[location_to_place_primary_tile].set_tile(MeadowTile())
        player.tiles[location_to_place_secondary_tile].set_tile(MeadowTile())
        ...
        self._expected_tiles: Dict[int, BaseTile] = {
            location_to_place_primary_tile: expected_placed_tile,
            location_to_place_secondary_tile: expected_placed_tile,
        }
