...
class test_when_insufficient_resources_exist_to_sow(Given_A_SowAction):
    ...
    def _initialise_player(self) -> BasePlayerService:
        ...
        player.give_resource(ResourceTypeEnum.veg, 2)
    ...
    def test_then_action_invoke_result_value_should_be_expected(self) -> None:
        self.assertEqual(self._action_invoke_result.value, 2)
