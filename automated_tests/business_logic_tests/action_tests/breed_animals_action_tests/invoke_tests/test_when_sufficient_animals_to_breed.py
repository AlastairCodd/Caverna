...
class test_when_sufficient_animals_to_breed(Given_A_BreedAnimalsAction):
    ...
    def test_then_action_invoke_result_value_should_be_expected(self) -> None:
        self.assertEqual(2, self._action_invoke_result.value)

    def test_then_action_invoke_result_errors_should_be_empty(self) -> None:
        self.assertEqual(len(cast(list, self._action_invoke_result.errors)), 0)
