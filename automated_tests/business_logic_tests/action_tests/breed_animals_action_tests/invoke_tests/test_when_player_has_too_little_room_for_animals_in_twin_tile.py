...
from buisness_logic.tiles.outdoor_tiles import PastureTile, PastureTwinTile
...
class test_when_player_has_too_little_room_for_animals_in_twin_tile(Given_A_BreedAnimalsAction):
    ...
    def _initialise_player(self) -> MockPlayer:
        self._starting_resources: Dict[ResourceTypeEnum, int] = {
            ResourceTypeEnum.sheep: 5,
            ResourceTypeEnum.boar: 5,
        ...
        pasture_twin_tile: BaseTile = PastureTwinTile()
