...
from buisness_logic.tiles.outdoor_tiles import PastureTwinTile
...
class test_when_player_has_sufficient_room_for_animals_in_twin_tile(Given_A_BreedAnimalsAction):
    ...
    def _initialise_player(self) -> MockPlayer:
        ...
        primary_outside_pasture_tile_entity: TileEntity = player.tiles[35]
        secondary_outside_pasture_tile_entity: TileEntity = player.tiles[27]
        pasture_twin_tile: BaseTwinTile = PastureTwinTile()
        primary_outside_pasture_tile_entity.set_tile(pasture_twin_tile)
        primary_outside_pasture_tile_entity.give_stable()
        secondary_outside_pasture_tile_entity.set_tile(pasture_twin_tile)
        secondary_outside_pasture_tile_entity.give_stable()

        pasture_twin_tile.place_tile(35, 27)
